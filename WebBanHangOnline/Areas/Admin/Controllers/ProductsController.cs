...
namespace WebBanHangOnline.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private Dictionary<string, IProductStatusStrategy> strategies;
        ...
        public ProductsController()
        {
            ...
            strategies = new Dictionary<string, IProductStatusStrategy>
            {
                { "IsActive", new IsActiveStrategy() },
                { "IsHome", new IsHomeStrategy() },
                { "IsSale", new IsSaleStrategy() }
            };
        }
        ...
        public class ProductRepository : IProductRepository
        {
            ...
            {
                return _context.Products.Find(productId); // Triển khai phương thức GetById
            }
        }
        ...
        public interface IProductStatusStrategy
            {
                void ChangeStatus(Product product);
            }
            public class IsActiveStrategy : IProductStatusStrategy
            {
            ...
            public class IsHomeStrategy : IProductStatusStrategy
            {
                public void ChangeStatus(Product product)
                {
            ...
            public class IsSaleStrategy : IProductStatusStrategy
            {
                public void ChangeStatus(Product product)
                {
        ...
        [HttpPost]
        public ActionResult ChangeProductStatus(int id, string strategyName)
        {
            if (strategies.ContainsKey(strategyName))
            {
                ...
                if (item != null)
                {
                    ...
                    strategy.ChangeStatus(item); // Áp dụng chiến lược cụ thể cho sản phẩm
